...
let paymentContainerDiv =
  document.getElementsByClassName("paymentContainer")[0];
let invoiceContainerDiv =
  document.getElementsByClassName("invoiceContainer")[0];
let susecssContainerDiv =
  document.getElementsByClassName("susecssContainer")[0];
